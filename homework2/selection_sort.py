# Сортировка выборкой
#
# Cуть алгоритма заключается в проходе по массиву
# От начала до конца в поиске минимального (или максимального)
# Элемента массива и перемещении его в начало (или конец)
#
